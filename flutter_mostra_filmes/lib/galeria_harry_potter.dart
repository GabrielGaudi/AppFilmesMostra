...
void main(){
  runApp(const GaleriaHP());
}


class GaleriaHP extends StatelessWidget {
  const GaleriaHP({super.key});
        ...
        trackVisibility: true,
           child: MasonryGridView.builder(
            ...
            itemBuilder: (context, imgNumber) => Padding(
              ...
              child: Image.asset("assets/galeria_harry_potter/harry_galeria${imgNumber + 1}.png"),
              ),
           ),
