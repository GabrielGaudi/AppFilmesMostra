    ...
    return Scaffold(
      ...
      body: Scrollbar(
        ...
        child: ListView(
          ...
          children: [
            IconButton(icon: Image.asset("assets/bela_fera_principal.png"), onPressed: (){ Navigator.push(context, MaterialPageRoute(builder: (context) => const GaleriaPagina()));},),
            IconButton(icon: Image.asset("assets/jumanji_principal.png"), onPressed: (){},),
            IconButton(icon: Image.asset("assets/harry_principal.png"), onPressed: (){},),
            IconButton(icon: Image.asset("assets/estomago_principal.png"), onPressed: (){},),
            IconButton(icon: Image.asset("assets/sociedade_poetas_principal.png"), onPressed: (){},),
          ],
        ),
      ),
