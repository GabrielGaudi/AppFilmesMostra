...
void main(){
  runApp(const GaleriaJumanji());
}


class GaleriaJumanji extends StatelessWidget {
  const GaleriaJumanji({super.key});
        ...
        trackVisibility: true,
           child: MasonryGridView.builder(
            ...
            itemBuilder: (context, imgNumber) => Padding(
              ...
              child: Image.asset("assets/galeria_jumanji/jumanji_galeria${imgNumber + 1}.jpeg"),
              ),
           ),
