...
void main(){
  runApp(const HarryPotterSobre());
}


class HarryPotterSobre extends StatefulWidget {
  const HarryPotterSobre({super.key});

  @override
  Potter createState() => Potter();

}

class Potter extends State<HarryPotterSobre>{

List<Elenco> elenco = List.empty();
List<Sobre> informacoes = List.empty();

 Future<void> elencoJson() async {
    final String response = await rootBundle.loadString('assets/galeria_HarryPotter.json');
    ...
    final String response = await rootBundle.loadString('assets/HarryPotter.json');
    Iterable data = await json.decode(response);
        ...
        child: ListView(
          ...
          children: [
            ...
            Column(
              ...
              spacing: 20.0,
              children: [
              Image.asset("assets/cartazes/harry_cartaz.png", height: 300,),
                Align(
              ...
              shrinkWrap: true,
                ...
                children: [
                  Image.asset("assets/harry_potter_sobre/diretor_harry.png", width: 260,),
              ...
              Column(
                ...
                children: [
                  ...
                  Image.asset("assets/harry_potter_sobre/warner.png"),
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(
                            ...
                            child: Text(style: TextStyle(fontFamily: "Caudex", fontSize: 22,),"   HarryPotter")
                          )
                        ],
                      ),
                    ],
