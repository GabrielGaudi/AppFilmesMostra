...
void main(){
  runApp(const GaleriaEstomago());
}


class GaleriaEstomago extends StatelessWidget {
  const GaleriaEstomago({super.key});
        ...
        trackVisibility: true,
           child: MasonryGridView.builder(
            ...
            itemBuilder: (context, imgNumber) => Padding(
              ...
              child: Image.asset("assets/galeria_estomago/estomago_galeria${imgNumber + 1}.jpeg"),
              ),
           ),
